...
import { Alert, ScrollView, AppRegistry, Platform, StyleSheet, Text, TouchableHighlight, TouchableOpacity, TouchableNativeFeedback, TouchableWithoutFeedback, View, Button, Image, TextInput, FlatList, SectionList, ActivityIndicator } from 'react-native';
    ...
    return(
      <View style={{flex: 1, paddingTop: 20}}>
        <FlatList
          ...
          renderItem={({item}) => <Text>{item.title}, {item.releaseYear}</Text>} keyExtractor={(item, index) => index}
        />
      </View>
    );
  }
